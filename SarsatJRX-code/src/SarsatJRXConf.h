...
#define SARSAT_JRX_VERSION "1.0.1"
...
#define NTP_SERVER3   "time.aws.com"
#define NTP_TIME_ZONE "CET-1CEST,M3.5.0,M10.5.0/3" // Europe/Paris (See https://github.com/nayarsystems/posix_tz_db/blob/master/zones.csv )
